...
Widget buildEventsHeaderSection() {
  return Align(
...
Widget buildEventsDescriptionSection() {
  return SizedBox(
...
Widget buildEventActionButtons(double width, double height) {
  return Row(
    children: [
      _buildActionButton(
        width: width * 0.32,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: height * 0.01),
                      Container(
                          width: width * 0.4, height: 16, color: Colors.white),
                      SizedBox(height: height * 0.004),
                      Container(
                          width: width * 0.25, height: 13, color: Colors.white),
                      SizedBox(height: height * 0.01),
                      Row(
                        children: [
                          Column(
